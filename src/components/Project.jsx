...
const Project = () => {
  return (
    <div name='project' className='w-full md:h-sc text-gray-300 bg-[#0a192f]'>
...
ReactJS Application
                        ...
                        <div className='pt-8 text-center'>
                            <a href="/">
                                <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 text-lg'>Live</button>
                            </a>
                            <a href="/">
