...
const Contact = () => {
  ...
  return (
    <div name='contact' className='w-full h-screen bg-[#DDD4D0] dark:bg-[#211A1D] text-black dark:text-gray-300 flex justify-center items-center p-4'>
        <form method='POST' action='https://getform.io/f/55bb6a98-4c36-4302-8c27-57c0f3ef92b7' className='flex flex-col max-w-xl w-full'>
            <div className='pb-8'>
                <h1 className='text-4xl font-bold inline border-b-4 border-[#f08080] dark:border-pink-600 dark:text-gray-300'>Contact</h1>
                <p className='dark:text-gray-300 text-xl py-6'>Submit the form below or click <a href="mailto:nghia.vo1452@gmail.com"><span className='underline underline-offset-2 hover:text-[#f08080] dark:hover:text-pink-600'>here</span></a> to send me an email.</p>
            </div>
